...
export default class MeasureControl implements IControl {
    ...
    constructor(options?: MeasureControlOptions) {
        ...
        this.geometryClick = options?.geometryClick || false;
                ...
                this.measures.forEach(mp => {
                    ...
                    if (pf) {
                        ...
                        copyBtn.addEventListener('click', e => {
                            this.copyToClipboard(JSON.stringify(pf.geometry));
                        });

                        cleanBtn.addEventListener('click', e => {
                            mp.measure.deleteFeature(pf.id!.toString());
                            this.popup.remove();
                        });
