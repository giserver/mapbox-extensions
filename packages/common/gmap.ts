export declare namespace gmap {
     ...
     * times in some situations. `gmap.workerUrl` and `gmap.workerCount`, if being
     ...
     * `gmap.clearPrewarmedResources()`. This is only necessary if your web page remains
    ...
    /**
     * Clears up resources that have previously been created by `gmap.prewarm()`.
    ...
    export class Map extends Evented {
        ...
        project(lnglat: LngLatLike): gmap.Point;

        unproject(point: PointLike): gmap.LngLat;
        ...
        addLayer(layer: gmap.AnyLayer, before?: string): this;

        moveLayer(id: string, beforeId?: string): this;

        removeLayer(id: string): this;

        getLayer(id: string): gmap.AnyLayer;
        ...
        setLight(light: gmap.Light, options?: FilterOptions): this;
         ...
         */
        queryTerrainElevation(lngLat: gmap.LngLatLike, options?: ElevationQueryOptions): number | null;

        setFeatureState(
            feature: FeatureIdentifier | gmap.MapboxGeoJSONFeature,
            state: { [key: string]: any },
        ): void;

        getFeatureState(feature: FeatureIdentifier | gmap.MapboxGeoJSONFeature): { [key: string]: any };

        removeFeatureState(target: FeatureIdentifier | gmap.MapboxGeoJSONFeature, key?: string): void;
        ...
        getCenter(): gmap.LngLat;

        setCenter(center: LngLatLike, eventData?: gmap.EventData): this;

        panBy(offset: PointLike, options?: gmap.AnimationOptions, eventData?: gmap.EventData): this;

        panTo(lnglat: LngLatLike, options?: gmap.AnimationOptions, eventdata?: gmap.EventData): this;

        getZoom(): number;

        setZoom(zoom: number, eventData?: gmap.EventData): this;

        zoomTo(zoom: number, options?: gmap.AnimationOptions, eventData?: gmap.EventData): this;

        zoomIn(options?: gmap.AnimationOptions, eventData?: gmap.EventData): this;

        zoomOut(options?: gmap.AnimationOptions, eventData?: gmap.EventData): this;

        getBearing(): number;

        setBearing(bearing: number, eventData?: gmap.EventData): this;
        ...
        resetNorth(options?: gmap.AnimationOptions, eventData?: gmap.EventData): this;

        resetNorthPitch(options?: gmap.AnimationOptions | null, eventData?: gmap.EventData | null): this;

        snapToNorth(options?: gmap.AnimationOptions, eventData?: gmap.EventData): this;
        ...
        fitBounds(bounds: LngLatBoundsLike, options?: gmap.FitBoundsOptions, eventData?: gmap.EventData): this;
        ...
        jumpTo(options: gmap.CameraOptions, eventData?: gmap.EventData): this;
        ...
        easeTo(options: gmap.EaseToOptions, eventData?: gmap.EventData): this;

        flyTo(options: gmap.FlyToOptions, eventData?: gmap.EventData): this;
    ...
    export interface MapboxOptions {
        ...
        /** stylesheet location */
        style?: gmap.Style | string | undefined;
        ...
        /**
         * If specified, map will use this token instead of the one defined in gmap.accessToken.
         *
         * @default null
         */
    ...
    */
    ...
    export class Popup extends Evented {
        constructor(options?: gmap.PopupOptions);

        addTo(map: gmap.Map): this;

        isOpen(): boolean;

        remove(): this;

        getLngLat(): gmap.LngLat;
    ...
    export class GeoJSONSource implements GeoJSONSourceRaw {
        ...
        constructor(options?: gmap.GeoJSONSourceOptions);
    ...
    export class VideoSource implements VideoSourceRaw {
        ...
        constructor(options?: gmap.VideoSourceOptions);
    ...
    export class ImageSource implements ImageSourceRaw {
        ...
        constructor(options?: gmap.ImageSourceOptions);
    ...
    export class LngLat {
        ...
        static convert(input: LngLatLike): gmap.LngLat;
    }
    ...
    export class LngLatBounds {
        ...
        extend(obj: gmap.LngLatLike | gmap.LngLatBoundsLike): this;

        /** Get the point equidistant from this box's corners */
        getCenter(): gmap.LngLat;

        /** Get southwest corner */
        getSouthWest(): gmap.LngLat;

        /** Get northeast corner */
        getNorthEast(): gmap.LngLat;

        /** Get northwest corner */
        getNorthWest(): gmap.LngLat;

        /** Get southeast corner */
        getSouthEast(): gmap.LngLat;
        ...
        static convert(input: LngLatBoundsLike): gmap.LngLatBounds;
    }
    ...
    export class Marker extends Evented {
        constructor(options?: gmap.MarkerOptions);

        constructor(element?: HTMLElement, options?: gmap.MarkerOptions);
    ...
    export interface FitBoundsOptions extends gmap.FlyToOptions {
        linear?: boolean | undefined;
        offset?: gmap.PointLike | undefined;
        maxZoom?: number | undefined;
        maxDuration?: number | undefined;
    }
    ...
    export interface CustomLayerInterface {
         ...
         */
        onRemove?(map: gmap.Map, gl: WebGLRenderingContext): void;
         ...
         * @param gl The gl context for the map.
         */
        onAdd?(map: gmap.Map, gl: WebGLRenderingContext): void;
